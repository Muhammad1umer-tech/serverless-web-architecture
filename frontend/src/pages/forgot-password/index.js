...
const ForgotPassword = () => {
  ...
  const SubmitForgetPassword = (e) => {
    ...
    axios
      .post(authConfig.forgetPassword, { email })
      .then((response) => {
        setLoading(false)
        setIsError(true)
      ...
      <RightWrapper>
        ...
        >
          <Box sx={{ width: '100%', maxWidth: 400 }}>
            ...
            <form noValidate autoComplete="off" onSubmit={SubmitForgetPassword}>
              <TextField
                name="email"
                autoFocus
                type="email"
              ...
              {Message && (
                  <FormHelperText
                    sx={{
                      color: isError ? '#388E3C' : '#D32F2F', // Darker shades of green and error
                      mb: '10px'
                    }}
                    id="">
                    {Message}
